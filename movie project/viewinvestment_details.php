...
<h1 style="text-color:white;font-size:200%;"><strong>VIEW OF INVESTMENT DETAILS TABLE</strong></h1>
    <div class="row">
...
$sql = 'SELECT * FROM investment_details';
...
<table class="data-table">
		...
		{
			$year  = $row['year'] == 0 ? '' : number_format($row['year']);
			echo '<tr>
