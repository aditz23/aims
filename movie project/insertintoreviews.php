...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>INSERT INTO REVIEWS TABLE</strong></h1>
    <div class="row">
...
$val=mysqli_query($con,"select * from review where imdb_score='$imdb_score' ");
$count=mysqli_num_rows($val);
if($_REQUEST['button']=='Insert')
{
	mysqli_query($con,"insert into review values('$director_name','$num_user','$num_critic','$imdb_score')");
}
