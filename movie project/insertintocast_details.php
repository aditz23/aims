...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>INSERT INTO CAST DETAILS TABLE</strong></h1>
    <div class="row">
...
$actor_name1=$_GET["actor_name1"];
$actor_name2=$_GET["actor_name2"];
$actor_name3=$_GET["actor_name3"];
$movie_title=$_GET["movie_title"];
$val=mysqli_query($con,"select * from cast_details where actor_name1='$actor_name1' ");
$count=mysqli_num_rows($val);
if($_REQUEST['button']=='Insert')
{
	mysqli_query($con,"insert into cast_details values('$actor_name1','$actor_name2','$actor_name3','$movie_title')");
}
$query=mysqli_query($con,"select * from  cast_details where actor_name1='$actor_name1'");
echo "<table class='styled' border=\"1\">";
echo "<tr><td class='head'>"."actor_name1"."</td><td class='head'>"."actor_name2"."</td><td class='head'>"."actor_name3"."</td><td class='head'>"."movie_title"."</td><td>"."</tr></td>";
while($row=mysqli_fetch_array($query))
{
	echo "<tr><td class='ele'>".$row['actor_name1']."</td><td class='ele'>".$row['actor_name2']."</td><td class='ele'>".$row['actor_name3']."</td><td class='ele'>".$row['movie_title']."</td><td>"."</tr></td>";
}
echo "</table>";
mysqli_close($con);
?>
