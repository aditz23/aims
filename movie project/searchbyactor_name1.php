...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>SEARCH BY ACTOR_NAME1</strong></h1>
    <div class="row">
...
$actor_name1=$_GET["Search"];
$query=mysqli_query($con,"select * from  cast_details where actor_name1='$actor_name1'");
echo "<table class='styled' border=\"1\">";
echo "<tr><td class='head'>"."actor_name1"."</td><td class='head'>"."actor_name2"."</td><td class='head'>"."actor_name2"."</td><td class='head'>"."movie_title"."</td><td>"."</tr></td>";
while($row=mysqli_fetch_array($query))
{
	echo "<tr><td class='ele'>".$row['actor_name1']."</td><td class='ele'>".$row['actor_name2']."</td><td class='ele'>".$row['actor_name2']."</td><td class='ele'>".$row['movie_title']."</td><td>"."</tr></td>";
}
echo "</table>";
?>
