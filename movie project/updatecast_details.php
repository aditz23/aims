...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>UPDATE CAST DETAILS TABLE</strong></h1>
    <div class="row">
...
{
	mysqli_query($con,"UPDATE cast_details SET actor_name1='$actor_name1', actor_name2='$actor_name2', actor_name3='$actor_name3', movie_title='$movie_title' WHERE actor_name1='$actor_name1'");
