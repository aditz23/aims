...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>DELETE FROM MOVIE DETAILS TABLE</strong></h1>
    <div class="row">
...
$val=mysqli_query($con,"DELETE FROM movie_details WHERE movie_title='$movie_title'");
echo "</table>";
?>
