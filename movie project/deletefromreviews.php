...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>DELETE FROM REVIEWS TABLE</strong></h1>
    <div class="row">
...
echo "</table>";
$val=mysqli_query($con,"DELETE FROM review WHERE imdb_score='$imdb_score'");
?>
