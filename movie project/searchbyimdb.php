...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>SEARCH BY IMDB_SCORE</strong></h1>
    <div class="row">
...
$imdb_score=$_GET["Search"];
$query=mysqli_query($con,"select * from  others where imdb_score='$imdb_score'");
