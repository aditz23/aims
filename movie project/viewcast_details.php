...
<h1 style="text-color:white;font-size:200%;"><strong>VIEW OF CAST DETAILS TABLE</strong></h1>
    <div class="row">
...
<table class="data-table">
		...
		{
			$movie_title  = $row['movie_title'] == 0 ? '' : number_format($row['movie_title']);
			echo '<tr>
					<td>'.$row['actor_name1'].'</td>
					<td>'.$row['actor_name2'].'</td>
					<td>'.$row['actor_name3'].'</td>
