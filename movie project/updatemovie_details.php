...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>UPDATE MOVIE DETAILS TABLE</strong></h1>
    <div class="row">
...
{
	mysqli_query($con,"UPDATE movie_details SET movie_title ='$movie_title', director_name='$director_name', actor_name1 ='$actor_name1', genre='$genre' WHERE movie_title = '$movie_title'");
}
