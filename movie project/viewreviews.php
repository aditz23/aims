...
<h1 style="text-color:white;font-size:200%;"><strong>VIEW OF REVIEWS TABLE</strong></h1>
    <div class="row">
...
<table class="data-table">
		...
		{
			$imdb_score  = $row['imdb_score'] == 0 ? '' : number_format($row['imdb_score']);
			echo '<tr>
					<td>'.$row['director_name'].'</td>
					<td>'.$row['num_user'].'</td>
					<td>'.$row['num_critic'].'</td>
					<td>'.$imdb_score.'</td>
				</tr>';
