...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>UPDATE OTHERS TABLE</strong></h1>
    <div class="row">
...
{
	mysqli_query($con,"UPDATE others SET country='$country', language='$language', plot='$plot', imdb_score= '$imdb_score' WHERE plot= '$plot'");
}
