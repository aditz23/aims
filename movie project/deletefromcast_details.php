...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>DELETE FROM CAST DETAILS TABLE</strong></h1>
    <div class="row">
...
echo "</table>";
$val=mysqli_query($con,"DELETE FROM cast_details WHERE actor_name1='$actor_name1'");
?>
