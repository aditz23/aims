...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>SEARCH BY DIRECTOR_NAME</strong></h1>
    <div class="row">
...
$director_name=$_GET["Search"];
$query=mysqli_query($con,"select * from  review where director_name='$director_name'");
