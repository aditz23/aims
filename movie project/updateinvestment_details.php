...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>UPDATE INVESTMENT DETAILS TABLE</strong></h1>
    <div class="row">
...
{
	mysqli_query($con,"UPDATE investment_details SET movie_title='$movie_title', budget='$budget', gross='$gross', year='$year' WHERE year = '$year'");
