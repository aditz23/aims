...
<h1 style="text-color:white;font-size:200%;text-align:center;"><strong>INSERT INTO INVESTMENT DETAILS TABLE</strong></h1>
    <div class="row">
...
$gross=$_GET["gross"];
$year=$_GET["year"];
$val=mysqli_query($con,"select * from investment_details where year='$year' ");
$count=mysqli_num_rows($val);
if($_REQUEST['button']=='Insert')
{
	mysqli_query($con,"insert into investment_details values('$movie_title','$budget','$gross','$year')");
}
